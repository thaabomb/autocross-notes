...
If you make more power than you can put down, the excess power is wasted. AWD is the most effective way to put power down. An AWD car with big power potential would make a fantastic autocross car. Bonus points if it's lightweight and has double wishbone suspension. This makes the Mitsubishi Eclipse / Eagle Talon TSi basically the perfect autocross car. Other exciting choices include: EVO, AWD CTR, NC1 NSX, Audis maybe?, Golf R, Huracán, 911 Turbo, Carrera4?, GTR, Tesla 3 Performance
...
BMWCCA,PCA, and NASA host autocross events too. Consider joining their events to get more runs in. Check MotorsportsReg.com and ClubRegistration.net.
